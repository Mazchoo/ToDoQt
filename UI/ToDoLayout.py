...
class Ui_ToDoLayout(object):
    def setupUi(self, ToDoLayout):
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(20, 50, 651, 41))
        ...
        self.loaderAnimation_label.setGeometry(QtCore.QRect(290, 560, 40, 40))
