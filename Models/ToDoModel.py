...
from Models.FileHelpers import (
    ...
    save_model_data, check_folder_path
)
...
class ToDoModel(QtStaticModel):
    ...
    def save_to_folder(self, rel_path: str):
        ...
        task_save_df = save_model_data(task_save_path, list(TaskEntry.model_fields.keys()),
                                       TASK_FIELDS_TO_ENCRYPT, all_task_data, original_task_data)
        ...
        project_save_df = save_model_data(project_save_path, list(Project.model_fields.keys()),
                                          PROJECT_FIELDS_TO_ENCRYPT, all_project_data, original_project_data)
    ...
    def load_from_folder(self, rel_path: str):
        ...
        decrypted_note_data = load_content_from_csv(path / SAVED_TASKS_FILENAME,
                                                    TASK_FIELDS_TO_ENCRYPT, TASK_FIELDS_APPLY_EVAL)
        ...
        decrypted_project_data = load_content_from_csv(path / SAVED_PROJECTS_FILENAME,
                                                       PROJECT_FIELDS_TO_ENCRYPT, PROJECT_FIELDS_APPLY_EVAL)
        all_projects = []
